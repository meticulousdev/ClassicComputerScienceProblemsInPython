...
if __name__ == "__main__":
    ...
    wine_network: NeuralNetwork = NeuralNetwork([13, 7, 3], 0.3)
    ...
    wine_trainers: torch.FloatTensor = torch.FloatTensor(wine_parameters[0:150])
    wine_trainers_corrects: torch.FloatTensor = torch.FloatTensor(wine_classifications[0:150])
    for _ in range(10):
        wine_network.train_nn(wine_trainers, wine_trainers_corrects)

    wine_testers: torch.FloatTensor = torch.FloatTensor(wine_parameters[150:178])
    wine_testers_corrects: torch.FloatTensor = torch.FloatTensor(wine_species[150:178])
