...
from CP_Chapter07.Example.util \
    import sigmoid, derivative_sigmoid, tanh, derivative_tanh, relu, derivative_relu
...
def parse_CSV(file_name: str,
              ...
              species_pos: int = 0, max_iter: int = 10) -> None:
...
if __name__ == "__main__":
    ...
    derivative_activation_function: Callable[[float], float] = derivative_sigmoid
    parse_CSV(file_name,
              layer_structure, learning_rate, input_range, output_list,
              train_range, test_range,
              activation_function, derivative_activation_function,
              species_pos, max_iter)
    print()

    print("activation function - tanh")
    activation_function: Callable[[float], float] = tanh
    derivative_activation_function: Callable[[float], float] = derivative_tanh
    parse_CSV(file_name,
              layer_structure, learning_rate, input_range, output_list,
              train_range, test_range,
              activation_function, derivative_activation_function,
    ...
    derivative_activation_function: Callable[[float], float] = derivative_relu
    parse_CSV(file_name,
              layer_structure, learning_rate, input_range, output_list,
              train_range, test_range,
              activation_function, derivative_activation_function,
